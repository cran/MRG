...
gsub("NA's", "NAs ", summary(himg0, digits = 5))
gsub("NA's", "NAs ", summary(himg1, digits = 5))
...
gsub("NA's", "NAs ", summary(himg3, digits = 5))
himg4$UAA = himg4$UAA + 0.001
gsub("NA's", "NAs ", summary(himg4, digits = 5))
gsub("NA's", "NAs ", summary(himg5, digits = 5))
s4 = Sys.time()
...
gsub("NA's", "NAs ", summary(himg1, digits = 5))
gsub("NA's", "NAs ", summary(himg2, digits = 5))
gsub("NA's", "NAs ", summary(himg3, digits = 5))
